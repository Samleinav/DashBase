...
use Botble\Dashplugin\Facades\DashHelper as HotelHelper;
...
class RegisterRequest extends Request
{
    public function rules(): array
    {
        ...
        return apply_filters('dash_customer_registration_form_validation_rules', $rules);
    }

    public function attributes(): array
    {
        return apply_filters('dash_customer_registration_form_validation_attributes', [
    ...
    {
        return apply_filters('dash_customer_registration_form_validation_messages', []);
    }
}
